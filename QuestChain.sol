...
contract QuestChainNFT is ERC721URIStorage, Ownable {
    ...
    constructor (address _questChainAddress)  ERC721("QuestChainNFT", "QCNFT") {
...
contract QuestChainCoreBridge is Ownable {
    ...
    constructor(address _questChainAddress, address _aggLayerAddress, uint256 _polygonChainId,address _polygonBridgeAddress) {
...
contract QuestChainPolygonBridge is Ownable {
    ...
    constructor(address _questChainAddress, address _aggLayerAddress, uint256 _coreDAOChainId) {
        questChainAddress = _questChainAddress;
        aggLayerAddress = _aggLayerAddress;
...
contract DeFiQuest is Ownable {
    ...
    constructor(address _questChain, address _stakingToken) {
...
contract NFTQuest is Ownable {
    ...
    constructor(address _questChain, address _nftContract){
        questChain = QuestChain(_questChain);
...
contract SocialQuest is Ownable {
    ...
    constructor(address _questChain) {
        questChain = QuestChain(_questChain);
    }
